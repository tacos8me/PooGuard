  ...
  if (user?.role !== 'admin') {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-bold text-dark-100 font-mono tracking-tight">Audit Log</h1>
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-dark-500 text-sm font-mono mt-1">Immutable record of all admin actions</p>
      </div>
